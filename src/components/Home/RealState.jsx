        ...
        <div className='flex flex-row justify-between w-[90%] h-[600px] mt-6'>
            <div className='flex flex-col justify-between w-[35%] h-[100%]'>
                <div className='w-full h-[48%] bg-[#000000] flex flex-col justify-end py-4 rounded-[12px] mi-div'>
                    <h1 className='text-[16px] text-gray300 text-left px-8'>Comiciones de solo 1%</h1>
                    <h1 className='text-[40px] text-gray100 text-left px-8'>Empeza con tan solo 10usd</h1>
                </div>
                <div className='w-full h-[48%] mi-degradado flex flex-col justify-center rounded-[12px]'>
                    <h1 className='text-[28px] text-gray200 text-left px-8'>Nuestra meta</h1>
                    <h1 className='text-[36px] text-gray100 text-left px-8'>Hacer accesibles las  inversiones de RealEstate</h1>
                </div>
            </div>
